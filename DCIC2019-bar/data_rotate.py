...
xmlpath = 'home/xml/'          #源图像路径
imgpath = 'home/imgs/'         #源图像所对应的xml文件路径
rotated_imgpath = 'home/rotatedimg/'
rotated_xmlpath = 'home/rotatedxml/'
...
# for angle in (60, ):
    for i in os.listdir(imgpath):
        ...
        for name in root.iter('annotation'):
            name.find('filename').text = (a + '_'+ str(angle) +'d.jpg')
            name.find('path').text = 'D:\\Temp\\pre\\home\\imgs\\' + a + '_'+ str(angle) +'d.jpg'
